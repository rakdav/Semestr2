...
//    public void Eat()
//    {
//        Console.WriteLine("Человек питается");
//    }
//    public void Move()=>Console.WriteLine("Человек идет");
//}
//class Car : IMovable, ICompute
//{
//    public void Compute() => Console.WriteLine("Вычисляет расход топлива");

//    public void Eat()
//    {
//        Console.WriteLine("Машина заправлется");
//    }
...
class Rectangle : Figure
{
    ...
    public double getPerimetr() => 2 * (height + width);
...
class Cylinder : Figure
{
    ...
    public double getArea() => 2 * Math.PI * (height + Circle!.Radius);
    public double getPerimetr() => 2 * (2 * Circle!.Radius + height);
    public override string? ToString()
    {
